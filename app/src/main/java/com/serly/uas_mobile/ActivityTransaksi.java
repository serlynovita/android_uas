...
import com.serly.uas_mobile.Adapter.TransaksiAdapter;
...
//        });
    ...
    public void buttonInsertTransaksi_onClick(View view) {
        Intent i = new Intent(this.getApplicationContext(),LayarInsertTransaksi.class);
        this.startActivity(i);
    }

    public void buttonBackTransaksi_onClick(View view) {
