...
public class LayarInsertBarang extends AppCompatActivity {
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layar_insert_barang);
        ...
        btInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ApiInterfaceBarang mApiInterfaceBarang = ApiClient.getClient().create(ApiInterfaceBarang.class);
                ...
                callInsert.enqueue(new Callback<GetBarang>() {
                    @Override
                    public void onResponse(Call<GetBarang> call, Response<GetBarang> response) {
                        if(response.body().getStatus().equals("failed")){
                            ...
                            tvMessage.setText("Retrofit Insert = " + response.body().getStatus() + "\n" );
                        }
                    }
